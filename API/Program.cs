...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "NewProj0410001", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<NewProj0410001Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NewProj0410001 API v1");
