...
using NewProj0410001.Entities;

namespace NewProj0410001.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class NewProj0410001Context : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-7723PEB\\SQLEXPRESS;Initial Catalog=T631688_NewProj0410001;Persist Security Info=True;user id=sa;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
